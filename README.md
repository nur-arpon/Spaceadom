...
![Hold the middle mouse button. Drift. Let go — Boom !](docs/screenshots/trailer.gif)

[Watch it with sound (mp4)](docs/trailer-mouse-ring.mp4) · every sound in it is the app's own kit.

## Screenshots

![Hold the middle mouse button, drift towards an app — Boom ! It opens !](docs/screenshots/slide-01.jpg)

![Hold Space, tap a letter — Boom ! Your app opens !](docs/screenshots/slide-02.jpg)

![Your touchpad's edges: brightness, volume, video.](docs/screenshots/slide-03.jpg)

![Apps anywhere. Any moment. Any instant.](docs/screenshots/slide-04.jpg)

![Any app. Any website. Any folder.](docs/screenshots/slide-05.jpg)

![Fun mode on: a living night sky.](docs/screenshots/slide-06.jpg)

![Every shortcut on screen while you hold. No memorising, ever.](docs/screenshots/slide-07.jpg)

![At an edge, the ring folds into an arc.](docs/screenshots/slide-08.jpg)

![Settings a kid could read.](docs/screenshots/slide-09.jpg)

![For advanced users: a beautiful way to reach infinite power.](docs/screenshots/slide-10.jpg)
...
**Proprietary** — see [LICENSE](LICENSE). The source is not published; this
repository carries the releases, the privacy policy and the project's
history. No redistribution of binaries, no selling, no derivative products. This
...
Spaceadom did not start as a launcher with a ring. It started in May 2026 as
**[SpaceToggle OS](https://github.com/nur-arpon/SpaceToggle-OS)** — an
AutoHotkey script whose whole idea was *hold Space, tap the first letter of an
app, and it opens; do it again and it closes*. That repository still holds
every script version from v3.6 to v11 with their dates. Spaceadom is the
native Rust rewrite of that idea, with an interface a person can edit, and the
icon rings came later as a second way in.

The dated timeline is in [HISTORY.md](HISTORY.md); what changed in each
release is in that release's notes under [Releases](../../releases).
